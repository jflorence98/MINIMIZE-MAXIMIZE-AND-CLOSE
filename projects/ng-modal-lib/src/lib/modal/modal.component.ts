...
export class ModalComponent implements AfterViewChecked {
  ...
  minimize() {
    ...
    this.modalRoot.nativeElement.style.left = 'auto';

    this.modalRoot.nativeElement.style.right = '0px';
  ...
  maximize() {
    ...
    this.preMaximizePageY = parseFloat(this.modalRoot.nativeElement.style.right);
